        ...
        <div class="col-md-6 col-sm-6 col-6">
            <div class="card mt-3" style="width: 150px;">
                ...
                <div class="card-body">
                    ...
                    <a href="{{url('1'.'/submenu')}}" class="stretched-link"></a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6 col-sm-6 col-6">
            <div class="card mt-3" style="width: 150px;">
                ...
                <div class="card-body">
                    ...
                    <a href="{{url('2'.'/submenu')}}" class="stretched-link"></a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6 col-sm-6 col-6">
            <div class="card mt-3" style="width: 150px;">
                ...
                <div class="card-body">
                    ...
                    <a href="{{url('3'.'/submenu')}}" class="stretched-link"></a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6 col-sm-6 col-6">
            <div class="card mt-3" style="width: 150px;">
                ...
                <div class="card-body">
                    ...
                    <a href="{{url('4'.'/submenu')}}" class="stretched-link"></a>
                </div>
            </div>
        </div>
    </div>
